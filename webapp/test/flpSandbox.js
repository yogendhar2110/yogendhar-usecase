					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#customerfeedback-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"customerfeedback-display": {
								"semanticObject": "customerfeedback",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customerfeedback",
									"url": sap.ui.require.toUrl("customerfeedback")
								}
							}
						}
					}
